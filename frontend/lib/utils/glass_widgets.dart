...
const kTeal = Color(0xFF14A7A0);
const kAccentCyan = Color(0xFF2ED1B0);
...
class GlassSectionCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final titleColor = isDark ? kAccentCyan : kTeal;
...
class GlassChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    final activeColor = selectedColor ?? kTeal;
            ...
            child: Container(
              ...
              child: Text(
                ...
                style: TextStyle(
                  color: selected
                      ? Colors.white
                      : (isDark ? const Color(0xFFC0CDD8) : const Color(0xFF4A5568)),
                  fontSize: 13,
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon: Icon(
                Icons.search,
                size: 18,
                color: isDark ? const Color(0xFFA5B3BF) : kTeal.withValues(alpha: 0.7),
              ),
              hintText: hintText,
              hintStyle: TextStyle(
                fontSize: 13,
...
class GlassButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final colors = gradientColors ?? [kTeal, kAccentCyan];
...
void showGlassSnackBar(BuildContext context, String message, {bool isError = false}) {
  final isDark = Theme.of(context).brightness == Brightness.dark;
  final iconColor = isError ? Colors.redAccent : kTeal;
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    message,
                    style: TextStyle(
                      color: isDark ? const Color(0xFFE6EDF3) : const Color(0xFF1F2933),
                      fontSize: 14,
                      fontWeight: FontWeight.w600,
                    ),
                  ),
